...
Console.WriteLine((DateTime.Now - dt).TotalMilliseconds); // и покажем после операций разницу между временем окончания и 
//временем начала в милисекундах. В одной секунде = 1000 милисекунд
